...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Aa667788@".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["dsm.qysos.com"];
pub const RS_PUB_KEY: &str = "1Pf4tMSps9qufLV7y0j+9RDF97ppypa0XslrbR6WdJk=";
